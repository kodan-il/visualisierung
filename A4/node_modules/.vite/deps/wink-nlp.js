...
// node_modules/wink-nlp/src/constants.js
var require_constants = __commonJS({
  "node_modules/wink-nlp/src/constants.js"(exports, module) {
    var consts = /* @__PURE__ */ Object.create(null);
    consts.UNK = 0;
...
// node_modules/wink-nlp/src/dd-wrapper.js
var require_dd_wrapper = __commonJS({
  "node_modules/wink-nlp/src/dd-wrapper.js"(exports, module) {
...
// node_modules/wink-nlp/src/locate.js
var require_locate = __commonJS({
  "node_modules/wink-nlp/src/locate.js"(exports, module) {
...
// node_modules/wink-nlp/src/contained-entities.js
var require_contained_entities = __commonJS({
  "node_modules/wink-nlp/src/contained-entities.js"(exports, module) {
...
// node_modules/wink-nlp/src/search.js
var require_search = __commonJS({
  "node_modules/wink-nlp/src/search.js"(exports, module) {
...
// node_modules/wink-nlp/src/api/get-parent-item.js
var require_get_parent_item = __commonJS({
  "node_modules/wink-nlp/src/api/get-parent-item.js"(exports, module) {
...
// node_modules/wink-nlp/src/api/col-get-item.js
var require_col_get_item = __commonJS({
  "node_modules/wink-nlp/src/api/col-get-item.js"(exports, module) {
...
// node_modules/wink-nlp/src/api/sel-get-item.js
var require_sel_get_item = __commonJS({
  "node_modules/wink-nlp/src/api/sel-get-item.js"(exports, module) {
...
// node_modules/wink-nlp/src/api/col-each.js
var require_col_each = __commonJS({
  "node_modules/wink-nlp/src/api/col-each.js"(exports, module) {
...
// node_modules/wink-nlp/src/api/sel-each.js
var require_sel_each = __commonJS({
  "node_modules/wink-nlp/src/api/sel-each.js"(exports, module) {
...
// node_modules/wink-nlp/src/api/col-filter.js
var require_col_filter = __commonJS({
  "node_modules/wink-nlp/src/api/col-filter.js"(exports, module) {
...
// node_modules/wink-nlp/src/api/sel-filter.js
var require_sel_filter = __commonJS({
  "node_modules/wink-nlp/src/api/sel-filter.js"(exports, module) {
...
// node_modules/wink-nlp/src/sort4FT.js
var require_sort4FT = __commonJS({
  "node_modules/wink-nlp/src/sort4FT.js"(exports, module) {
    module.exports = (a, b) => {
      if (b[1] > a[1]) {
        return 1;
      } else if (b[1] < a[1]) {
...
// node_modules/wink-nlp/src/sentence-wise-importance.js
var require_sentence_wise_importance = __commonJS({
  "node_modules/wink-nlp/src/sentence-wise-importance.js"(exports, module) {
    var constants = require_constants();
    var bits4lemma = constants.bits4lemma;
    var posMask = constants.posMask;
    var tkSize = constants.tkSize;
    var sentenceWiseImportance = function(rdd) {
      const openClassPOS = /* @__PURE__ */ Object.create(null);
      ...
      const posGroupWeightTable = /* @__PURE__ */ Object.create(null);
      for (let s = 0; s < sentences.length; s += 1) {
        ...
        for (let k = 0; k + NGram - 1 < pos.length; k += 1) {
          ...
          posGroupWeightTable[posGroup] = posGroupWeightTable[posGroup] || /* @__PURE__ */ Object.create(null);
...
// node_modules/wink-nlp/src/reconstruct-spaces.js
var require_reconstruct_spaces = __commonJS({
  "node_modules/wink-nlp/src/reconstruct-spaces.js"(exports, module) {
    var constants = require_constants();
    var tkSize = constants.tkSize;
    var psMask = constants.psMask;
    var reconstructSpaces = function(index, rdd) {
      var token = rdd.tokens[index * tkSize + 1];
      var count = token & psMask;
...
// node_modules/wink-nlp/src/its.js
var require_its = __commonJS({
  "node_modules/wink-nlp/src/its.js"(exports, module) {
    ...
    var its = /* @__PURE__ */ Object.create(null);
    ...
    its.lemma = function(index, rdd, addons) {
      ...
      if (tokens[index * tkSize + 1] > 65535) {
        return cache.value(tokens[index * tkSize + 2] & lemmaMask);
      }
...
// node_modules/wink-nlp/src/contained-markings.js
var require_contained_markings = __commonJS({
  "node_modules/wink-nlp/src/contained-markings.js"(exports, module) {
    var locate = require_locate();
    var containedMarkings = function(markings, start, end) {
      if (markings === void 0 || start === void 0 || end === void 0) {
        return null;
      }
...
// node_modules/wink-nlp/src/as.js
var require_as = __commonJS({
  "node_modules/wink-nlp/src/as.js"(exports, module) {
    var sort4FT = require_sort4FT();
    ...
    as.bow = function(tokens) {
      var bow = /* @__PURE__ */ Object.create(null);
      var t;
...
// node_modules/wink-nlp/src/allowed.js
var require_allowed = __commonJS({
  "node_modules/wink-nlp/src/allowed.js"(exports, module) {
    var its = require_its();
    var as = require_as();
...
// node_modules/wink-nlp/src/api/itm-token-out.js
var require_itm_token_out = __commonJS({
  "node_modules/wink-nlp/src/api/itm-token-out.js"(exports, module) {
    var its = require_its();
...
// node_modules/wink-nlp/src/api/col-tokens-out.js
var require_col_tokens_out = __commonJS({
  "node_modules/wink-nlp/src/api/col-tokens-out.js"(exports, module) {
    var its = require_its();
    var as = require_as();
    var allowed = require_allowed();
    var reconstructSpaces = require_reconstruct_spaces();
...
// node_modules/wink-nlp/src/api/sel-tokens-out.js
var require_sel_tokens_out = __commonJS({
  "node_modules/wink-nlp/src/api/sel-tokens-out.js"(exports, module) {
    var its = require_its();
    var as = require_as();
    var allowed = require_allowed();
    var reconstructSpaces = require_reconstruct_spaces();
...
// node_modules/wink-nlp/src/api/itm-entity-out.js
var require_itm_entity_out = __commonJS({
  "node_modules/wink-nlp/src/api/itm-entity-out.js"(exports, module) {
    var its = require_its();
    var as = require_as();
    var allowed = require_allowed();
    ...
    var itmEntityOut = function(index, entities, rdd, itsf) {
      ...
      var detail;
      if (itsfn === its.detail) {
        detail = /* @__PURE__ */ Object.create(null);
...
// node_modules/wink-nlp/src/api/col-entities-out.js
var require_col_entities_out = __commonJS({
  "node_modules/wink-nlp/src/api/col-entities-out.js"(exports, module) {
    var its = require_its();
    var as = require_as();
    var allowed = require_allowed();
...
// node_modules/wink-nlp/src/api/sel-entities-out.js
var require_sel_entities_out = __commonJS({
  "node_modules/wink-nlp/src/api/sel-entities-out.js"(exports, module) {
    var its = require_its();
    var as = require_as();
    var allowed = require_allowed();
    var itmEntityOut = require_itm_entity_out();
...
// node_modules/wink-nlp/src/api/itm-sentence-out.js
var require_itm_sentence_out = __commonJS({
  "node_modules/wink-nlp/src/api/itm-sentence-out.js"(exports, module) {
    var its = require_its();
    var as = require_as();
    var allowed = require_allowed();
    var colTokensOut = require_col_tokens_out();
...
// node_modules/wink-nlp/src/api/col-sentences-out.js
var require_col_sentences_out = __commonJS({
  "node_modules/wink-nlp/src/api/col-sentences-out.js"(exports, module) {
...
// node_modules/wink-nlp/src/api/itm-document-out.js
var require_itm_document_out = __commonJS({
  "node_modules/wink-nlp/src/api/itm-document-out.js"(exports, module) {
    var its = require_its();
    var as = require_as();
    var allowed = require_allowed();
    var colTokensOut = require_col_tokens_out();
...
// node_modules/wink-nlp/src/api/print-tokens.js
var require_print_tokens = __commonJS({
  "node_modules/wink-nlp/src/api/print-tokens.js"(exports, module) {
    var constants = require_constants();
    var tkSize = constants.tkSize;
    var psMask = constants.psMask;
    var bits4lemma = constants.bits4lemma;
...
// node_modules/wink-nlp/src/doc-v2.js
var require_doc_v2 = __commonJS({
  "node_modules/wink-nlp/src/doc-v2.js"(exports, module) {
    ...
    var doc = function(docData, addons) {
      ...
      contextualVectors = function({ lemma = true, specificWordVectors = [], similarWordVectors = false, wordVectorsLimit = 0 } = {}) {
        ...
        cv.size = 0;
        cv.words = [];
        cv.vectors = /* @__PURE__ */ Object.create(null);
        ...
        if (similarWordVectors) {
          ...
          for (let i = 0; i < similarWords.length; i += 1) {
            if (cv.vectors[similarWords[i]] === void 0) {
        ...
        cv.words = Object.keys(cv.vectors).map((w) => ({ w, i: cv.vectors[w][cv.wordIndex] < 0 ? Infinity : cv.vectors[w][cv.wordIndex] })).sort((a, b) => a.i - b.i).map((o) => o.w);
...
// node_modules/wink-nlp/src/cache.js
var require_cache = __commonJS({
  "node_modules/wink-nlp/src/cache.js"(exports, module) {
    var constants = require_constants();
    ...
    var cache = function(model, featureFn) {
      ...
      var efHash = /* @__PURE__ */ Object.create(null);
      efHash.tokenType = true;
      efList.forEach((ef) => efHash[ef] = true);
      var getFeaturesIndex = function(name, value2) {
        ...
        var index = h[value2];
        if (index === void 0) {
          index = h[value2] = f.index;
          f.index = l.push(value2);
          isNewValue = 1;
        }
      ...
      var normal = function(index) {
        ...
        if (index < lexemeIntrinsicSize) {
          ...
          if (isSpellingMapped) {
            normIndex = (lexicon[layout4lemma[0] + index * pkSize] & layout4lemma[1]) >>> layout4lemma[2];
          } else {
            normIndex += index;
          }
        } else {
          ...
          if (normIndex < lexemeIntrinsicSize) {
            ...
            if (isSpellingMapped) {
              normIndex = (lexicon[layout4lemma[0] + normIndex * pkSize] & layout4lemma[1]) >>> layout4lemma[2];
            }
          }
        }
        return normIndex;
      ...
      var mappedSpelling = function(index) {
        ...
        if (index < lexemeIntrinsicSize) {
          isSpellingMapped = (lexicon[layout4mapped[0] + index * pkSize] & layout4mapped[1]) >>> layout4mapped[2];
          if (isSpellingMapped) {
            mappedIndex = (lexicon[layout4lemma[0] + index * pkSize] & layout4lemma[1]) >>> layout4lemma[2];
          }
        }
        return mappedIndex;
      };
...
// node_modules/wink-nlp/src/recursive-tokenizer.js
var require_recursive_tokenizer = __commonJS({
  "node_modules/wink-nlp/src/recursive-tokenizer.js"(exports, module) {
    var RGX = 0;
    var CAT = 1;
...
// node_modules/wink-nlp/src/tokenizer.js
var require_tokenizer = __commonJS({
  "node_modules/wink-nlp/src/tokenizer.js"(exports, module) {
...
// node_modules/wink-nlp/src/compile-trex.js
var require_compile_trex = __commonJS({
  "node_modules/wink-nlp/src/compile-trex.js"(exports, module) {
    ...
    var compileTRex = function(trex) {
      ...
      return { rtc, ltc, helpers };
    };
    module.exports = compileTRex;
  }
});

// node_modules/wink-nlp/src/tokens-mappers.js
var require_tokens_mappers = __commonJS({
  "node_modules/wink-nlp/src/tokens-mappers.js"(exports, module) {
    var constants = require_constants();
    var tkSize = constants.tkSize;
    var bits4lemma = constants.bits4lemma;
    var posMask = constants.posMask;
    var mappers = /* @__PURE__ */ Object.create(null);
...
// node_modules/wink-nlp/src/compose-patterns.js
var require_compose_patterns = __commonJS({
  "node_modules/wink-nlp/src/compose-patterns.js"(exports, module) {
    var regex = /\[.*?\]/g;
...
// node_modules/wink-nlp/src/identify-marked-area.js
var require_identify_marked_area = __commonJS({
  "node_modules/wink-nlp/src/identify-marked-area.js"(exports, module) {
...
// node_modules/wink-nlp/src/automaton.js
var require_automaton = __commonJS({
  "node_modules/wink-nlp/src/automaton.js"(exports, module) {
    ...
    var simpleFSM = function(cache, token2Ignore) {
      var methods = /* @__PURE__ */ Object.create(null);
      var fsm = /* @__PURE__ */ Object.create(null);
      const root = 0;
      var lastUsedState = 0;
      var terminalStates = /* @__PURE__ */ Object.create(null);
      var markedStates = /* @__PURE__ */ Object.create(null);
      var customPropertyAtStates = /* @__PURE__ */ Object.create(null);
      var substitutions;
      ...
      var learnSinglePattern = function(name, pattern, mark, customProperty) {
        ...
        for (let k = 0; k < length; k += 1) {
          ev = pattern[k];
          if (fsm[state] === void 0) {
            fsm[state] = /* @__PURE__ */ Object.create(null);
      ...
      var setPatternSwap = function(patterns) {
        ...
        substitutions = /* @__PURE__ */ Object.create(null);
      ...
      var emptyModelJSON = function() {
        ...
        m0[0] = /* @__PURE__ */ Object.create(null);
        return JSON.stringify(
          [
            100,
            0,
...
// node_modules/wink-nlp/src/examples-compiler.js
var require_examples_compiler = __commonJS({
  "node_modules/wink-nlp/src/examples-compiler.js"(exports, module) {
    ...
    var compiler = function(cerModel, cache, tokenize, matchValue) {
      ...
      var tokenizeText = function(text) {
        var rdd = /* @__PURE__ */ Object.create(null);
        rdd.cache = cache;
        rdd.tokens = [];
      ...
      var compileSimplePattern = function(text) {
        ...
        const replacements = /* @__PURE__ */ Object.create(null);
      ...
      var run = function(examples) {
        const ces = [];
        preserve = /* @__PURE__ */ Object.create(null);
...
// node_modules/wink-nlp/src/helper.js
var require_helper = __commonJS({
  "node_modules/wink-nlp/src/helper.js"(exports, module) {
    var helper = /* @__PURE__ */ Object.create(null);
...
// node_modules/wink-nlp/src/wink-nlp.js
var require_wink_nlp = __commonJS({
  "node_modules/wink-nlp/src/wink-nlp.js"(exports, module) {
    var DocDataWrapper = require_dd_wrapper();
    ...
    var nlp = function(theModel, pipe = null, wordEmbeddings = null) {
      ...
      var compiler;
      var cerMetaModel;
      var validAnnotations = /* @__PURE__ */ Object.create(null);
      var currPipe = /* @__PURE__ */ Object.create(null);
      ...
      var readDoc = function(text) {
        ...
        rdd.nonBreakingSpaces = /* @__PURE__ */ Object.create(null);
        var wrappedDocData = DocDataWrapper(rdd);
        tokenize(wrappedDocData, text);
...
${JSON.stringify(ex, null, 2)}`);
              ...
              if (ex.mark !== void 0 && (!helper.isIntegerArray(ex.mark) || ex.mark.length !== 2 || ex.mark.length === 2 && ex.mark[0] > ex.mark[1])) {
...
${JSON.stringify(ex, null, 2)}`);
        ...
        cerConfig = config === void 0 || config === null ? /* @__PURE__ */ Object.create(null) : JSON.parse(JSON.stringify(config));
      ...
      if (wordEmbeddings !== null) {
        ...
        let numOfKeys = 0;
        const wordVectorKeys = /* @__PURE__ */ Object.create(null);
...
//# sourceMappingURL=wink-nlp.js.map
